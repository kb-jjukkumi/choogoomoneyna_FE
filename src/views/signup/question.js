export const questionList = [
  {
    ...
    subtitle:
      '지금 쓰고있는 스마트폰이 아직 쓸만하지만, 신형 모델이 너무 예쁘다!',
    options: [
  ...
  },
  {
    ...
    subtitle:
      '무더위 속 갑자기 눈에 띈 편의점 행사. 아이스크림 2+1 행사를 하고있다',
    options: [
  ...
  },
  {
    ...
    question: '친구와의 저녁 약속',
    subtitle:
      '친구에게 저녁을 먹자는 연락이 왔다. 카톡창에 뜬 "오늘은 스테이크 어때?". 1인분에 3만원 이상 지출이 예상되는 저녁약속!',
    options: [
      { value: 1, label: '가격이 부담된다고 솔직히 말하기' },
      { value: 2, label: '약속에 가지만.. 속으로 가격이 부담된다고 생각한다' },
  ...
  },
  {
    ...
    subtitle:
      '딱 배가 고픈 저녁시간. 배달앱 추천에 16,000원짜리 1인세트가 눈에 밟힌다. 먹고싶은 메뉴지만 가격이 살짝 부담되는 상황!',
    options: [
  ...
  },
  {
    ...
    subtitle:
      '계절이 바뀐 지금. 옷이 있지만 새로운 계절을 맞아 새 옷을 사고싶다! 여러 사이트를 둘러보지만 꽤나 큰 금액..',
    options: [
  ...
  },
  {
    ...
    subtitle:
      '중고 마켓을 둘러보던 중 눈에 들어오는 신발! 예전부터 갖고 싶던 모델을 발견했다. 정가는 10만 원이지만, 어느새 20만 원에 팔리고 있다.',
    options: [
  ...
  },
  {
    ...
    subtitle:
      '친한 친구에게서 온 연락. "우리 여행 가자!" 하지만 요즘 예산이 빠듯한 상황이다.',
    options: [
  ...
  },
  {
    ...
    subtitle:
      '요즘 푹 빠진 모바일 게임. 그런데 게임 도중에 계속 나오는 30초 광고가 너무 거슬린다! 6000원에 광고 제거 기능을 구매할 수 있다는데!',
    options: [
  ...
  },
  {
    ...
    subtitle:
      '평소에 2,000원 아메리카노를 마시는 당신. 하지만 오늘은 유난히 피곤하다. 마침 5,000원 "딸기 휘핑라떼"가 눈에 들어오는데!',
    options: [
